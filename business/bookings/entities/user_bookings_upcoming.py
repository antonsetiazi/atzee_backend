# business/bookings/entities/user_bookings_upcoming.py
...
class UserBookingsUpcomingEntity(BaseEntity):
    """
    business.user.bookings.upcoming
    """

    key = "user.bookings.upcoming"
    domain = "business"
