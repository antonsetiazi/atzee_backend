# business/bookings/entities/user_bookings_history.py
...
class UserBookingsHistoryEntity(BaseEntity):
    """
    business.user.bookings.history
    Menampilkan seluruh booking milik user (upcoming + completed + cancelled)
    """
