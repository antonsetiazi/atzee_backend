# core/widgets/ui/pages/banners/banner_edit.py
...
UI_PAGES = Page(
    key="widgets.banners.edit",
    entity="widgets",
    domain="core",
    title="Edit Banner",
    path="/admin/widgets/banners/:id",
    permissions=[CorePermission.ADMIN_WIDGETS_EDIT],
    data_source="/entities/core/widgets.detail/query/",
    blocks=[
        FormBlock(
            mode="edit",
            submit_to="/entities/core/widgets.update/execute/",
            method="POST",
            redirect_to={
